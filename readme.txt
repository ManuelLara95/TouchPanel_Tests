...
@par Example Description 
 ...
 color that he can choose from the displayed list of clors in the buttom of the
...
@par Hardware and Software environment 
  ...
  - This example has been tested with STM32F429I-DISCO (MB1075) RevA and can be
